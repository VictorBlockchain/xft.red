            ...
            <section className="cs-page_head cs-bg" style={{backgroundImage: "url(/img/page_head_bg.svg)"}}>
                <div className="container">
                    <div className="text-center">
                        <h1 className="cs-page_title">Grabbit</h1>
                        <ol className="breadcrumb">
                        <li className="breadcrumb-item"><a href="/">Home</a></li>
                        <li className="breadcrumb-item active">Grabbit</li>
                        </ol>
                    </div>
                </div>
            </section>
                    ...
                    <div className="col-lg-6">
                        ...
                        <div style={{width: '100%', display: 'inline-block'}}>
                            ...
                            <div className="col-4 text-center">
                                  <a href="#" className="cs-btn cs-style1 cs-btn_lg">Slap</a>
                                </div>
                                <div className="col-4 text-center">
                                <a href="#" className="cs-btn cs-style1 cs-btn_lg">Grab</a>
                                </div>
                                <div className="col-4 text-center">
                                <a href="#" className="cs-btn cs-style1 cs-btn_lg">Sneek</a>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            ...
                            {_display.holding <1 && (
                                <div className="">
                                    ...
                                    {_display.ondisplay && (<a href="#" onClick={() => openModal(10)}  className="cs-btn cs-style1 cs-btn_lg  text-center"><i className="mdi mdi-spotlight"></i> Grab</a>)}
                                    {_display.ondisplay && (<a href="#" onClick={() => openModal(10)}  className="cs-btn cs-style1 cs-btn_lg  text-center"><i className="mdi mdi-spotlight"></i> Slap</a>)}
                                    {_display.ondisplay && (<a href="#" onClick={() => openModal(10)}  className="cs-btn cs-style1 cs-btn_lg  text-center"><i className="mdi mdi-spotlight"></i> Sneek</a>)}
                                </div>
                            )}
                            {seller==account && (
                                <div className="">
